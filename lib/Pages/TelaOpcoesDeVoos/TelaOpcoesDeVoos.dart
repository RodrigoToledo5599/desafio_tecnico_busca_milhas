...
class TelaOpcoesDeVoosState extends State<TelaOpcoesDeVoos> {
  ...
  TextEditingController n_passageiros_adultos_controller =
      TextEditingController();
  TextEditingController n_passageiros_criancas_controller =
      TextEditingController();
  TextEditingController n_passageiros_bebes_controller =
      TextEditingController();
  ...
  Future<bool> sendingScript() async {
    ...
    if (int.parse(this.n_passageiros_bebes_controller.text) +
            int.parse(this.n_passageiros_criancas_controller.text) +
            int.parse(this.n_passageiros_adultos_controller.text) >
        9) {
      setState(() {
  ...
  @override
  void dispose() {
    aeroporto_controller_origem.dispose();
    aeroporto_controller_destino.dispose();
    data_controller_ida.dispose();
    horario_controller_ida.dispose();
    data_controller_volta.dispose();
    horario_controller_volta.dispose();
    companhia_aerea_controller.dispose();
    tipo_de_viagem_controller.dispose();
    n_passageiros_adultos_controller.dispose();
    n_passageiros_criancas_controller.dispose();
    n_passageiros_bebes_controller.dispose();
    super.dispose();
  }
                ...
                child: SingleChildScrollView(
                  child: Padding(
                    ...
                    child: Column(children: [
                      PesquisaAeroporto(
                          controller: aeroporto_controller_origem,
                          label_text: "Origem"),
                      PesquisaAeroporto(
                          controller: aeroporto_controller_destino,
                          label_text: "Destino"),
                      ...
                      SelectCompanhiaAerea(
                          controller: companhia_aerea_controller),
                      SelectNPassageiros(
